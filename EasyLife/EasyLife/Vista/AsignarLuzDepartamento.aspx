<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="AsignarLuzDepartamento.aspx.cs" Inherits="EasyLife.Vista.AsignarLuzDepartamento" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Asignar Luz Departamento</title>
</asp:Content>
    ...
    <section class="form-control mb-4" style="width: 40%; height: auto; margin-left: 30%; margin-top: 6%; background-color: #BB8FCE;">
        <form class="text-center border border-light p-5" action="#!">
            <div class="h4 mb-4 text-center">
                <asp:Label ID="lbOpcion" runat="server" Text="Asignar Luz Departamento" CssClass="h4 mb-4 text-center" ForeColor="Black"></asp:Label>
            </div>
            <%-- Campo de ingreso de Opcion --%>
            <asp:Label ID="Label3" runat="server" Text="Opcion" ForeColor="Black"></asp:Label><br />
            ...
            <div style="display: inline-block;">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="dplDepartamento"
                    Display="Dynamic" InitialValue="Seleccione un Departamento" ValidationGroup="luz"></asp:RequiredFieldValidator>
            ...
            <div style="display: inline-block;">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="dplLuz"
                    Display="Dynamic" ValidationGroup="luz"></asp:RequiredFieldValidator>
            </div>
            <br />
            <br />
            ...
            <asp:GridView ID="grLuces" runat="server" CssClass="table table-striped w-auto" AutoGenerateColumns="False" DataKeyNames="_ID_LUZ_D"
                ...
                <Columns>
                    <asp:BoundField DataField="_CODIGO_LUZ_D" HeaderText="Luz" SortExpression="_CODIGO_LUZ_D" />
